...
public class InterestController {
	...
	public ResponseEntity<String> processAccountEndOfDayBalances() {
		try {
	...
	public ResponseEntity<String> calculateMonthlyInterest(@PathVariable("month") String month,
		...
		try {
			...
			respentity = ResponseEntity.status(HttpStatus.OK).body(mapper.writeValueAsString(lst.join()));
